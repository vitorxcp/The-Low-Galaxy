...
//Dando e tirando dindin 
    if(gm.includes(args[1])) db.subtract("user_"+message.author.id+".guild_"+message.guild.id+".dinheiro.coins", valor)
      if(gm.includes((valor+300))) db.add("user_"+message.author.id+".guild_"+message.guild.id+".dinheiro.coins", (valor+300))
        if(gm.includes((valor*3))) db.add("user_"+message.author.id+".guild_"+message.guild.id+".dinheiro.coins", (valor*3))
    //embeds{
    const Discord = require("discord.js")
    let desg = "`|-=-=-=-X-=-=-=-|`"
    embed = new Discord.MessageEmbed()
