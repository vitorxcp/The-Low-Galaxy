...
//  if(message.author.id !== "518862457876250625") return message.reply("Comando em fase final de teste! (quando aparece esta mensagem e para prevenir futuros erros)")
  ...
  .setTimestamp()
    .setTitle("**    *`🪙 Lojinha`*:**")
  .addField("🔫 Arma (`t.comprar arma`) - *`20.000`* Galaxy's.", "> Esta arma te dará `+15%` de chance de não ser pego pela policia!")
     .addField("✨ Multiplicador de Galaxy's (`t.comprar mpgalaxy`) - *`1.000.000`* Galaxy's.", "> Este item te dará `2x` mais Galaxy's!")
